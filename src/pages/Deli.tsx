...
const MENU_ITEMS: Record<string, Array<{ name: string; description: string; tag?: string; image?: string }>> = {
    ...
    hot_sandwiches: [
        { name: "Fried Bologna", description: "Thick slice of bologna, fried until crisp.", image: "/images/fried-bologna-hot.png" },
        { name: "Spicy Chicken", description: "Crispy chicken breast with spicy seasoning.", tag: "Spicy", image: "/images/spicy-chicken-hot.png" },
        { name: "Regular Chicken", description: "Crispy fried chicken breast sandwich.", image: "/images/regular-chicken-hot.png" },
        { name: "Cheeseburger", description: "Juicy beef patty with melted cheese and fixings.", image: "/images/cheeseburger.png" },
        { name: "Hamburger", description: "Classic beef patty on a bun.", image: "/images/hamburger.png" },
        { name: "Steak Sandwich", description: "Tender steak served on a roll.", image: "/images/steak-hot.png" },
        { name: "BLT", description: "Bacon, lettuce, and tomato on toasted bread.", image: "/images/blt.png" },
    ],
    hot_sides: [
